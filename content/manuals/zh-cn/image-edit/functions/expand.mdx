...
1. **比例合理**：扩展比例不要过大，避免生成内容质量下降
2. **内容协调**：扩展的内容必须与原有内容风格协调
3. **边缘处理**：注意扩展区域与原有内容的边缘融合
4. **提示词清晰**：提供清晰的扩展内容描述，确保AI理解需求
...
1. **比例合理**：选择合理的扩展比例，避免过度扩展
2. **描述清晰**：提供清晰的扩展内容描述
3. **风格协调**：确保扩展内容与原有内容风格协调
4. **分步扩展**：对于大幅扩展，可以分多次进行

## 使用建议

### 轻微扩展
对于小幅调整，使用1.0-1.5的扩展比例即可。

### 中等扩展
对于一般需求，使用1.5-2.0的扩展比例较为合适。

### 大幅扩展
对于需要大量新内容的场景，可以使用2.0-3.0的扩展比例，但要注意内容质量。

### 方向选择
根据具体需求选择合适的扩展方向，避免不必要的扩展。
